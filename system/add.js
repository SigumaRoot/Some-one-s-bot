...
module.exports={
    async addCmd(config){
        ...
        const commandFolders = fs.readdirSync(`/home/runner/${config.BuildName}/commands`);
        ...
        for (const folder of commandFolders) {
            ...
            const commandFiles = fs.readdirSync(`/home/runner/${config.BuildName}/commands/${folder}`).filter(file => file.endsWith(".js"));
            for (const file of commandFiles) {
                const command = require(`/home/runner/${config.BuildName}/commands/${folder}/${file}`);
