...
declare const _default: <T extends Record<string, Validator<any>>>(rule_object?: T | undefined) => ObjectValidator<{ [K in keyof T]: T[K] extends Validator<infer U> ? U : undefined; }>;
/**
