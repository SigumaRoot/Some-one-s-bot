 ...
 */
declare type iValidationResult<T> = {
    success: true;
...
export { validate, withValidBody, withValidQuery, STRING, NUMBER, BOOLEAN, LIST, OBJECT, NULL, UNDEFINED, OR, CLASS, iValidationError, iValidationResult };
