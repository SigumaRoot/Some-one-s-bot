...
class PlaylistParser {
    static parse(data, playlistId) {
        ...
        }, interfaces_1.PLAYLIST_FULL);
    }
    static parseSearchResult(item) {
        const flexColumns = (0, traverseList_1.default)(item, "flexColumns");
        const artistId = (0, traverseString_1.default)(flexColumns[1], "browseId")();
        return (0, checkType_1.default)({
            type: "PLAYLIST",
            ...
            artist: {
                artistId,
                name: (0, traverseString_1.default)(flexColumns[1], "runs", "text")(-2)
            },
            videoCount: +(0, traverseList_1.default)(flexColumns[1], "runs", "text")
                .at(-1)
                .split(" ")
                .at(0)
                .replaceAll(",", ""),
