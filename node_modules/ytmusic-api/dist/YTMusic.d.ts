import { AlbumDetailed, AlbumFull, ArtistDetailed, ArtistFull, PlaylistFull, SearchResult, SongDetailed, SongFull, VideoDetailed, VideoFull } from "./";
export default class YTMusic {
     ...
     * @param query Query string
     */
    searchPlaylists(query: string): Promise<PlaylistFull[]>;
    /**
